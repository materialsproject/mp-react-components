export interface MatElement {
  ...
  shells: number[],
  category: string,
  category_2?: string, // predicted or probably
  symbol: string,
  density: number | null,
...
export const TABLE_V2: MatElement[] = [
  ...
  },
  {
    ...
    "boil": 630,
    "category": "unknown",
    "category_2": 'alkali metal', // predicted
    "color": null,
    "density": 3,
...
export const TABLE_DICO_V2: Readonly<{[element:string]: MatElement}> =
  TABLE_V2.reduce((acc: any, el) => {
    acc[el.symbol] = el;
    return acc;
  }, {});
