...
import './MaterialsInputFormulaButtons.css';

interface Props {
  onClick: (value: string) => any;
}

export const MaterialsInputFormulaButtons: React.FC<Props> = props => {
  ...
  return (
    <div className="pt-formula-buttons">
      ...
      >
        <span className="mat-symbol"><FaAsterisk/></span>
      </button>
      {values.map((v, i) => (
        <button
          key={i}
          type="button"
          className="mat-element"
